...
body,html{
  background:#C8D8F0;
  background-image:
    radial-gradient(ellipse at 15% 15%, rgba(37,99,235,0.35) 0%, transparent 55%),
    radial-gradient(ellipse at 85% 80%, rgba(124,58,237,0.25) 0%, transparent 55%),
    radial-gradient(ellipse at 55% 5%, rgba(8,145,178,0.2) 0%, transparent 45%),
    radial-gradient(ellipse at 10% 85%, rgba(16,185,129,0.15) 0%, transparent 40%);
...
.hdr{
  ...
  box-shadow:0 1px 0 rgba(0,0,0,0.05), 0 4px 24px rgba(11,25,41,0.04);
...
.xp-card{
  ...
  box-shadow:0 2px 12px rgba(11,25,41,0.06), inset 0 1px 0 rgba(255,255,255,0.8);
}
...
.scripture-card{
  ...
  box-shadow:0 2px 12px rgba(37,99,235,0.08), inset 0 1px 0 rgba(255,255,255,0.9);
}
...
.col323-footer{text-align:center;padding:24px 20px 8px;margin-top:8px;}
.col323-verse{font-size:13px;font-style:italic;color:#64748B;line-height:1.6;}
.col323-ref{font-size:11px;font-weight:700;color:#2563EB;letter-spacing:0.08em;text-transform:uppercase;margin-top:4px;}
...
.journal-entry-card{
  ...
  box-shadow:0 2px 12px rgba(11,25,41,0.05), inset 0 1px 0 rgba(255,255,255,0.9);
}
...
.plan-card{
  ...
  box-shadow:0 2px 16px rgba(11,25,41,0.06), inset 0 1px 0 rgba(255,255,255,0.9);
}
...
.fin-card{
  ...
  box-shadow:0 2px 16px rgba(11,25,41,0.06), inset 0 1px 0 rgba(255,255,255,0.85);
}
...
.prac-card{
  ...
  border-radius:17px;padding:17px 10px;text-align:center;cursor:pointer;transition:all 0.25s;
  box-shadow:0 2px 12px rgba(11,25,41,0.05), inset 0 1px 0 rgba(255,255,255,0.9);
}
...
.bottom-nav{
  ...
  box-shadow:0 -1px 0 rgba(0,0,0,0.04), 0 -4px 24px rgba(11,25,41,0.04);
